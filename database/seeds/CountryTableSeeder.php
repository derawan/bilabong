...
class CountryTableSeeder extends Seeder
{
    ...
    public function run()
    {
        $country_list = [
            ...
            ['country_name'=>'Korea (the Democratic People\'s Republic of)', 'country_code'=>'KP'],
            ...
            ['country_name'=>'Lao People\'s Democratic Republic (the)', 'country_code'=>'LA'],
            ...
            ['country_name'=>'Syrian Arab Republic (the)', 'country_code'=>'SY'],
            ['country_name'=>'Taiwan (Province of China)', 'country_code'=>'TW'],
            ['country_name'=>'Tajikistan', 'country_code'=>'TJ'],
            ['country_name'=>'Tanzania, the United Republic of', 'country_code'=>'TZ'],
            ...
            ['country_name'=>'United Kingdom of Great Britain and Northern Ireland (the)', 'country_code'=>'GB'],
            ['country_name'=>'United States Minor Outlying Islands (the)', 'country_code'=>'UM'],
        ...
        foreach($country_list as $country) {
            //\Irfansjah\Gtx\Models\Country::create($country);
